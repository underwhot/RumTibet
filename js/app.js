    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu") || document.querySelector("html").classList.contains("menu-open") && !e.target.classList.contains("menu__body")) {
                    bodyLockToggle();
        ...
        if (document.querySelector("[data-picker]")) new index_es("[data-picker]", {
            range: true,
            multipleDatesSeparator: " - "
        });
        window["FLS"] = false;
